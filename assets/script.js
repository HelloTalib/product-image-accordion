    ...
    var core = {
      ...
      init: function init() {
        ...
        var defaults = {
          ...
          elementClass: "uwk-accordion", // element class {string}
          triggerClass: "uwk-accordion-trigger", // trigger class {string}
          panelClass: "uwk-accordion-panel", // panel class {string}
          activeClass: "uwk-active", // active element class {string}
      ...
      generateIDs: function generateIDs(element) {
        ...
        element.setAttribute("id", "uwk-accordion-".concat(uniqueId));
        trigger.setAttribute("id", "uwk-accordion-trigger-".concat(uniqueId));
        panel.setAttribute("id", "uwk-accordion-panel-".concat(uniqueId));
      },
      ...
      setARIA: function setARIA(element) {
        ...
        trigger.setAttribute(
          "aria-controls",
          "uwk-accordion-panel-".concat(uniqueId)
        );
        ...
        panel.setAttribute(
          "aria-labelledby",
          "uwk-accordion-trigger-".concat(uniqueId)
        );
      },
